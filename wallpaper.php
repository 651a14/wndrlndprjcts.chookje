...
<script>
	...
	<body>
		...
		<ul>
			...
			<li><a href="video.html" class="video"><img src="img/video.png"></a></li>
			<li class="selector">
...
<div class="container">
	<div class="logo">
		<a href="video index.html"><img src="img/17sp-title.png" width="150" height="107" class="sp-title"></a><br />
...
<script type="text/javascript">
	$(document).ready(function(){ 
		...
		<div class="photo-wrapper">
			<div class="slider-wrap">
				<div id='slider' class='swipe'>
		            <div class='swipe-wrap'>
		                <div><img src="img/wallpaper/1.png"></div>
		                <div><img src="img/wallpaper/2.png"></div>
		                <div><img src="img/wallpaper/3.png"></div>
		                <div><img src="img/wallpaper/4.png"></div>
		                <div><img src="img/wallpaper/5.png"></div>
		                <div><img src="img/wallpaper/6.png"></div>
		                <div><img src="img/wallpaper/7.png"></div>
		                <div><img src="img/wallpaper/8.png"></div>
		                <div><img src="img/wallpaper/9.png"></div>
		            </div>             
			...
			<div class="past">
				<ul>
					<li><a href="bynutae.php"><img src="img/wallpaper/bynutae.png"></a></li>	
					<li><a href="#" class="active"><img src="img/wallpaper/byvv.png"></a></li>	
				</ul>
			</div>
		</div>
